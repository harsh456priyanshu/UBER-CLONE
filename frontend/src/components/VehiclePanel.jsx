      ...
      <h5 className='p-1 text-center w-[93%] absolute top-0' onClick={() => {
        ...
        <h3 className='text-2xl font-semibold mb-5'>Choose a Vechile</h3>
          ...
          <div onClick={() => {
            ...
            <img className='h-12' src='https://swyft.pl/wp-content/uploads/2023/05/how-many-people-can-a-uberx-take.jpg.webp' alt='' />
          ...
          <div onClick={() => {
            ...
            <h2 className='text-lg font-semibold'>₹65.10</h2>
          </div>
